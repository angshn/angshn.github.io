import{_ as n,o as s,c as a,e as p}from"./app-1OpTEKPL.js";const t={},o=p(`<h2 id="倒排索引" tabindex="-1"><a class="header-anchor" href="#倒排索引"><span>倒排索引</span></a></h2><p>倒排索引是指根据文档内容和文档id做关联，也就是说根据关键字来关联<strong>主键</strong>。</p><h2 id="主要概念" tabindex="-1"><a class="header-anchor" href="#主要概念"><span>主要概念</span></a></h2><p>Index： 索引</p><p>Document: 文档</p><h2 id="索引操作" tabindex="-1"><a class="header-anchor" href="#索引操作"><span>索引操作</span></a></h2><h3 id="创建索引" tabindex="-1"><a class="header-anchor" href="#创建索引"><span>创建索引</span></a></h3><p>PUT <code>http://localhost:9200/shoping</code>，即可创建一个索引</p><h3 id="获取索引信息" tabindex="-1"><a class="header-anchor" href="#获取索引信息"><span>获取索引信息</span></a></h3><p>GET <code>http://localhost:9200/shoping</code>，即可获取</p><h3 id="删除索引" tabindex="-1"><a class="header-anchor" href="#删除索引"><span>删除索引</span></a></h3><p>DELETE <code>http://localhost:9200/shoping</code></p><h2 id="文档操作" tabindex="-1"><a class="header-anchor" href="#文档操作"><span>文档操作</span></a></h2><h3 id="创建文档" tabindex="-1"><a class="header-anchor" href="#创建文档"><span>创建文档</span></a></h3><p>发送POST请求<code>http://localhost:9200/shoping/_doc</code>，<code>_doc</code>表示在<code>shoping</code>的索引下新增文档。这里不能使用PUT方法新增，因为PUT方式要求幂等性，但是新增请求可能会有重复消息所以不能使用PUT。</p><p>发送的请求体如下：</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>
