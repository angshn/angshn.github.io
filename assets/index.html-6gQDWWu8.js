import{_ as n,o as s,c as a,e}from"./app-O2pfA_0v.js";const p={},t=e(`<h1 id="行人检测" tabindex="-1"><a class="header-anchor" href="#行人检测" aria-hidden="true">#</a> 行人检测</h1><p><strong>TODO</strong>:</p><ul><li>[ ] 行人检测介绍</li><li>[ ] 现有数据集</li><li>[ ] 评价指标</li></ul><h2 id="行人检测简要介绍" tabindex="-1"><a class="header-anchor" href="#行人检测简要介绍" aria-hidden="true">#</a> 行人检测简要介绍</h2><h2 id="数据集" tabindex="-1"><a class="header-anchor" href="#数据集" aria-hidden="true">#</a> 数据集</h2><p><code>CityPersons</code>: cityscapes数据集的子集</p><p><code>CrowdHuman</code>: 复杂场景的行人检测数据集，每张图片的人数要大大多于citypersons</p><h2 id="评价指标" tabindex="-1"><a class="header-anchor" href="#评价指标" aria-hidden="true">#</a> 评价指标</h2><p><code>MR-2</code>: log-average missing rate, 对数平均丢失率。通常是在9个FPPI值下取平均miss rate。</p><p><code>FPPI</code>: <code>False Negetive Per Image</code>，每张图片的FN</p><p>在<code>mmdetection</code>中的计算代码如下</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">eval_mr</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> score_list<span class="token punctuation">,</span> gt_num<span class="token punctuation">,</span> img_num<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),o=[t];function i(c,l){return s(),a("div",null,o)}const r=n(p,[["render",i],["__file","index.html.vue"]]);export{r as default};
